...
contract('KicksCrowdsale', function ([deployer, founder, manualSeller, rateSetter, investor, investor2, investor3]) {
    ...
    let bonus20capBoundary = new BN('800000000000000000000000');
    let bonus10capBoundary = new BN('1533333333333333333333333');
    ...
    beforeEach(async function () {
        ...
        //await this.crowdsale.addWhitelisted(investor2, {from: deployer});
        await this.crowdsale.addWhitelisted(investor3, {from: deployer});
    });
